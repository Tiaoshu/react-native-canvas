...
public class SketchCanvasManager extends SimpleViewManager<SketchCanvas> {
    ...
    public Map<String,Integer> getCommandsMap() {
        ...
        map.put("restorePath", COMMAND_ADD_PATH);
    ...
    public void receiveCommand(SketchCanvas view, int commandType, @Nullable ReadableArray args) {
        switch (commandType) {
            ...
            case COMMAND_NEW_PATH: {
                view.newPath(args.getInt(0), args.getInt(1), args.getInt(2), args.getBoolean(3));
                return;
            }
            case COMMAND_CLEAR: {
                view.clear();
            ...
            case COMMAND_ADD_PATH: {
                ...
                view.addPath(args.getInt(0), args.getInt(1), args.getInt(2), pointPath, args.getBoolean(4));
                return;
            }
